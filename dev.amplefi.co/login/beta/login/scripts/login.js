...
// Global functions & variables 
	...
	var previousRegister = $.url().param('previousRegister');
	...
	if (showRegister == 'true'){$('.alert').empty().append('Check your email for instructions to set your password').css('display', 'block');}
	if (showMessagePass == 'true'){$('.alert').empty().append('Check your email for instructions to reset your password').css('display', 'block');}
	if (previousRegister == 'true'){$('.alert').empty().append('You are already registered. Please login.').css('display', 'block');}
